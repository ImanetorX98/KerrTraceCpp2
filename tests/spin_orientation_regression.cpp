...
struct GeoPixelRaw {
    ...
    float sky_dth_a, sky_dph_a; // footprint on the celestial sphere
    float sky_dth_b, sky_dph_b;
};
static_assert(sizeof(GeoPixelRaw) == 64, "GeoPixelRaw must match GeoPixel in main.cpp");
